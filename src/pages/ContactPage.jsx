...
const ContactPage = () => {
  ...
  return (
    <div className="relative min-h-screen pt-24 sm:pt-32 pb-12 sm:pb-20">
      {/* Header Section */}
      <div className="container mx-auto px-4"> {/* Ensured container wraps the whole page content for consistent padding */}
        <div className="max-w-4xl mx-auto mb-10 sm:mb-12 text-center">
          <div className="w-16 sm:w-20 h-16 sm:h-20 bg-gradient-to-br from-sky-500 to-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-5 sm:mb-6 shadow-lg">
        ...
        <div className="max-w-6xl mx-auto"> {/* Removed px-4 from here as parent now has it */}
          <div className="grid lg:grid-cols-3 gap-8 sm:gap-10">
            ...
            <div className="lg:col-span-1 space-y-8 sm:space-y-10">
              ...
              {/* Quick Links */}
              <div className="bg-white/70 backdrop-blur-xl rounded-2xl shadow-xl border border-white/50 p-6 sm:p-8">
                <h3 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-6">Quick Access</h3>
                <div className="space-y-3">
                  <Link to="/pages" className="flex items-center space-x-3 text-sky-600 hover:text-sky-700 transition-colors duration-200 group">
                    <svg className="w-5 h-5 group-hover:text-sky-500 transition-colors" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clipRule="evenodd"/>
                    </svg>
                    <span>Research Papers</span>
                  </Link>
                  <Link to="/#intro" className="flex items-center space-x-3 text-sky-600 hover:text-sky-700 transition-colors duration-200 group">
                    <svg className="w-5 h-5 group-hover:text-sky-500 transition-colors" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white/70 backdrop-blur-xl rounded-2xl shadow-xl border border-white/50 p-6 sm:p-8">
                <h2 className="text-2xl sm:text-3xl font-semibold text-gray-900 mb-8">Send us a Message</h2>
