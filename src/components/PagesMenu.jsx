    ...
    <div className="min-h-screen bg-gradient-to-br from-sky-50 to-blue-100">
      <div className="container mx-auto px-4 py-8 pt-32">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Research Pages</h1>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="group bg-white/70 backdrop-blur-xl rounded-2xl shadow-xl border border-white/50 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden">
            <div className="bg-gradient-to-r from-sky-500 to-blue-600 p-6 text-white">
              ...
              <h2 className="text-xl font-bold mb-2">Dirac Propagator</h2>
            ...
            <div className="p-6">
              ...
              <a 
                href={diracLink} 
                className="group/btn w-full bg-gradient-to-r from-sky-500 to-blue-600 text-white py-3 px-4 rounded-lg font-semibold hover:from-sky-600 hover:to-blue-700 transition-all duration-200 shadow-md hover:shadow-lg flex items-center justify-center space-x-2"
              >
          ...
          <div className="group bg-white/50 backdrop-blur-xl rounded-2xl shadow-lg border border-white/50 hover:shadow-xl transition-all duration-300 overflow-hidden opacity-60">
            <div className="bg-gradient-to-r from-gray-400 to-gray-500 p-6 text-white">
              ...
              <h2 className="text-xl font-bold mb-2">TGD Many-Sheeted Space-time</h2>
          ...
          <div className="group bg-white/50 backdrop-blur-xl rounded-2xl shadow-lg border border-white/50 hover:shadow-xl transition-all duration-300 overflow-hidden opacity-60">
            <div className="bg-gradient-to-r from-gray-400 to-gray-500 p-6 text-white">
              ...
              <h2 className="text-xl font-bold mb-2">Quantum Memory Models</h2>
              <p className="text-gray-200 text-sm">
        ...
        <div className="mt-16 text-center">
          <div className="bg-white/70 backdrop-blur-xl rounded-2xl shadow-xl border border-white/50 p-8 max-w-2xl mx-auto">
            <h3 className="text-2xl font-bold text-gray-900 mb-4">Contribute to TGD Research</h3>
